      ...
      <nav class="nav container">
        ...
        <div class="nav__menu" id="nav-menu">
          <ul class="nav__list">
            ...
            <li class="nav__item">
              <a href="login-register.php" class="nav__link active-link">Đăng Nhập</a>
            </li>
          </ul>
        ...
        <div class="login-register__container container grid">
          <div class="register">
            ...
            <form action="" method="post" class="form grid">
              <input type="text" name="user" placeholder="Nhập tên đăng nhập" class="form__input">
              <span>
                <?php
                if (!empty($error['user'])) {
